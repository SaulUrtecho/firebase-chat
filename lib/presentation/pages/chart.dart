        ...
        body: SafeArea(
            child: Column(
              ...
              StreamBuilder<QuerySnapshot>(
                stream: _fireStore.collection('message').orderBy('created', descending: true).snapshots(),
                  ...
                  children: [
                    ...
                    TextButton(
                      onPressed: () async {
                        ...
                        try {
                          final result = await _fireStore.collection('message').add({
                            'message': messageText,
...
class MessageBubble extends StatelessWidget {
  MessageBubble({required this.sender, required this.text, required this.isLoggedIn});
  final String sender;
  final String text;
